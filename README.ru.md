...
![coverage](https://img.shields.io/badge/coverage-71.7%25-yellow)
...
Сервер обязан поддерживать предсказуемый REST-контракт: идемпотентные PUT-запросы, стабильную пагинацию и проверку конфликтов по `updatedAt`. Полное руководство с примерами и чеклистом см. в [`docs/backend-transport.md`](docs/backend-transport.md).
